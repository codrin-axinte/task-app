...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-base-200 shadow-lg border-b border-gray-900">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <NavLink :href="route('tasks.index')" :active="route().current('tasks.index')">
                                    <Squares2X2Icon class="w-4 h-4 mr-1"/>
                                    Dashboard
                                </NavLink>
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-base-content bg-base-100 hover:text-primary focus:outline-none transition ease-in-out duration-150"
                                            >
